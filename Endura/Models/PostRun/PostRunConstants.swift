...
public let defaultUserWarmups: [RoutineDifficulty: RoutineData] = [
    .easy: RoutineData(
        type: .warmup,
        description: "An easy warmup routine to help you prepare for your run.",
        exercises: [
            RoutineExercise(.ankleStretch, 20),
            RoutineExercise(.calfStretch, 10),
            RoutineExercise(.hamstringStretch, 10),
        ]
    ),
    .medium: RoutineData(
        type: .warmup,
        description: "A medium-intensity warmup routine to help you prepare for your run.",
        exercises: [
            RoutineExercise(.ankleStretch, 20),
            RoutineExercise(.calfStretch, 10),
            RoutineExercise(.hamstringStretch, 10),
            RoutineExercise(.quadricepsStretch, 10),
            RoutineExercise(.hipFlexorStretch, 10),
            RoutineExercise(.butterflyStretch, 10),
            RoutineExercise(.groinStretch, 10),
            RoutineExercise(.lowerBackStretch, 10),
            RoutineExercise(.tricepsStretch, 10),
            RoutineExercise(.shoulderStretch, 10),
            RoutineExercise(.neckStretch, 10),
            RoutineExercise(.chestStretch, 10),
            RoutineExercise(.backStretch, 10),
            RoutineExercise(.sideStretch, 10),
            RoutineExercise(.wristFlexorStretch, 10),
            RoutineExercise(.wristExtensorStretch, 10),
            RoutineExercise(.innerThighStretch, 10),
        ]
    ),
    .hard: RoutineData(
        type: .warmup,
        description: "A hard warmup routine to help you prepare for your run.",
        exercises: [
            RoutineExercise(.ankleStretch, 20),
            RoutineExercise(.calfStretch, 10),
            RoutineExercise(.hamstringStretch, 10),
            ...
            RoutineExercise(.forwardLungeWithTwist, 5),
            RoutineExercise(.backwardLunge, 5),
            RoutineExercise(.sideSlide, 10),
            RoutineExercise(.sideJumpJacks, 10),
            RoutineExercise(.frontPlank, 10),
            RoutineExercise(.sidePlank, 10),
            RoutineExercise(.backPlank, 10),
            RoutineExercise(.otherSidePlank, 10),
